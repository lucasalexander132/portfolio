...
Objective proof of the issue (e.g. URLs, reports, headers, crawl data, screenshots, metrics). Do not rely on intuition or best-practice claims.
...
What should be done to resolve the issue. Do not include implementation steps unless explicitly requested.
